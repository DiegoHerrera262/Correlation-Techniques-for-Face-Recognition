%VLC CORRELATOR SIMPLE SIMULATION FOR FACE RECOGNITION 4.5-LUIS CARLOS DURAN
%Date: 09-05-2020
...
img_r=imread('pic.png');
img_r2=imread('pic2.png');img_r2=imresize3(img_r2,size(img_r));
img_r3=imread('pic3.png');img_r3=imresize3(img_r3,size(img_r));
img_r4=imread('pic4.png');img_r4=imresize3(img_r4,size(img_r));
img_r5=imread('pic5.png');img_r5=imresize3(img_r5,size(img_r));
img_r6=imread('pic6.png');img_r6=imresize3(img_r6,size(img_r));
img_r7=imread('pic7.png');img_r7=imresize3(img_r7,size(img_r));
img_r8=imread('pic8.png');img_r8=imresize3(img_r8,size(img_r));
img_r9=imread('pic9.png');img_r9=imresize3(img_r9,size(img_r));
img_r10=imread('pic10.png');img_r10=imresize3(img_r10,size(img_r));
img_r11=imread('pic11.png');img_r11=imresize3(img_r11,size(img_r));
img_r12=imread('pic12.png');img_r12=imresize3(img_r12,size(img_r));
img_r13=imread('pic13.png');img_r13=imresize3(img_r13,size(img_r));
img_r14=imread('pic14.png');img_r14=imresize3(img_r14,size(img_r));
img_r15=imread('pic15.png');img_r15=imresize3(img_r15,size(img_r));
img_r16=imread('pic16.png');img_r16=imresize3(img_r16,size(img_r));
img_r17=imread('pic17.png');img_r17=imresize3(img_r17,size(img_r));
img_r18=imread('pic18.png');img_r18=imresize3(img_r18,size(img_r));
img_r19=imread('pic19.png');img_r19=imresize3(img_r19,size(img_r));
img_r20=imread('pic20.png');img_r20=imresize3(img_r20,size(img_r));
%TEST IMAGES
img_t=imread('face3.png');img_t=imresize3(img_t,size(img_r));% Resizes the image
