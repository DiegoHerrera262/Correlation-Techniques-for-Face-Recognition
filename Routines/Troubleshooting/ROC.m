...
function usedImages = ROC...
  ...
  %% Plot ROC curve
 tol =0.05; % Define a tolerance range to find an aproximate value for FNR=FPR
 index = abs(FNR-FPR) < tol;
 index_Numb=find(index);%index(:);
