%VLC CORRELATOR SIMPLE SIMULATION FOR FACE RECOGNITION-using only eyes as ref 2-LUIS CARLOS DURAN
%Date: 06-05-2020
...
%HERE THE ZEROS ARE ADDED TO THE FT MATRIX
...
Fr= padarray(Fr,[i j],0);

%THIS ONLY WOULD BE TO SEE HOW ARE THE SHIFTED |FT| NOW THAT WE ADDED THE ZEROS
Fr_sh=padarray(Fr_sh,[i j],0); %Since Ft and Ft_sh have the same size this works here
