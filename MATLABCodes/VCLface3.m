%VLC CORRELATOR SIMPLE SIMULATION FOR FACE RECOGNITION 3-LUIS CARLOS DURAN
%Date: 03-05-2020
%This code calculates and shows the result of the correlation function
%between a target and a reference image, using the method of a VLC type architecture and multiple references(10).
...
img_r7=imread('face7.png');img_r7=imresize3(img_r7,size(img_r));
img_r8=imread('face8.png');img_r8=imresize3(img_r8,size(img_r));
img_r9=imread('face9.png');img_r9=imresize3(img_r9,size(img_r));
img_r10=imread('face10.png');img_r10=imresize3(img_r10,size(img_r));
%TEST IMAGES
img_t=imread('face5.png');img_t=imresize3(img_t,size(img_r));% Resizes the image
