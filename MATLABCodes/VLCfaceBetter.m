...
%The folder "more" contains all the images of my face that have been used
%until now (that is "face-face10" and "eyes-eyes10"):
clear all;
close all;
clc;
clf;
path=addpath('C:\Users\Lucho xD\Desktop\Eighth Semester\Measures in Optics and Acoustics\Idea 1 proyecto\Image_Database\more');
%READING AL PNG FILES
read_files= dir('C:\Users\Lucho xD\Desktop\Eighth Semester\Measures in Optics and Acoustics\Idea 1 proyecto\Image_Database\more\*.png'); 
